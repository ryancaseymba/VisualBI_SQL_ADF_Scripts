/****** Object:  StoredProcedure [etl].[LoadTimeDimension]    Script Date: 9/16/2020 3:36:13 AM ******/
SET ANSI_NULLS ON
GO
	...
	BEGIN 
		...
		BEGIN 
			...
			BEGIN 
				...
				SELECT @Time12 = FORMAT(CAST(@Time24 AS DATETIME),'hh:mm:ss tt'), @Time24TimeFormat = CAST(@Time24 AS TIME)
